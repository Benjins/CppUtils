...
cl /Od /Zi /DBNS_DEBUG /DEXIT_ON_ASSERT /DMEMSTREAM_TEST_MAIN strings.cpp assert.cpp memstream.cpp stringmap.cpp hash.cpp /Fememstream_test
if %ERRORLEVEL% NEQ 0 goto somethingbad
...
cl /Od /Zi /DBNS_DEBUG /DEXIT_ON_ASSERT /DBNVPARSER_TEST_MAIN lexer.cpp strings.cpp assert.cpp hash.cpp vector.cpp memstream.cpp bnvm.cpp bnvparser.cpp /Febnvparser_test
if %ERRORLEVEL% NEQ 0 goto somethingbad
...
cl /Od /Zi /DBNS_DEBUG /DEXIT_ON_ASSERT /DBNVM_TEST_MAIN lexer.cpp strings.cpp assert.cpp hash.cpp stringmap.cpp memstream.cpp bnvm.cpp vector.cpp bnvparser.cpp /Febnvm_test
if %ERRORLEVEL% NEQ 0 goto somethingbad
